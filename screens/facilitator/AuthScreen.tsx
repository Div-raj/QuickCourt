      ...
      case AuthScreenType.Login:
        return (
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-bold text-text-dark">Business Email</label>
              <div className="mt-1">
      ...
      case AuthScreenType.SignUp:
        return (
          <form onSubmit={handleSignUp} className="space-y-4">
             ...
             <div>
                <label className="block text-sm font-bold text-text-dark">Business / Venue Name</label>
                <input type="text" required className={`${commonInputClass} mt-1`}/>
            </div>
            <div>
                <label className="block text-sm font-bold text-text-dark">Business Email</label>
                <input type="email" required className={`${commonInputClass} mt-1`}/>
            </div>
            <div>
                <label className="block text-sm font-bold text-text-dark">Phone Number</label>
                <input type="tel" required className={`${commonInputClass} mt-1`}/>
            </div>
             <div>
                <label className="block text-sm font-bold text-text-dark">Business Address</label>
