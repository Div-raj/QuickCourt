...
export const UsersIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962A3.75 3.75 0 0 1 15 12a3.75 3.75 0 0 1-2.25 3.512M7.5 12a3.75 3.75 0 0 1 3-3.512A3.75 3.75 0 0 1 15 8.25v-1.5a3.75 3.75 0 0 1 3.75-3.75a3.75 3.75 0 0 1 3.75 3.75v1.5A3.75 3.75 0 0 1 18.75 12h-1.5m-7.5-2.25A3.75 3.75 0 0 0 6 12v1.5a3.75 3.75 0 0 0-3.75 3.75v1.5A3.75 3.75 0 0 0 6 21v-1.5A3.75 3.75 0 0 0 9.75 16.5h1.5" />
    </svg>
);
...
export const QuoteIcon = ({ className = 'w-10 h-10' }: { className?: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M14.017 21v-7.391c0-2.908.972-4.995 2.917-6.284v3.097c-1.24.68-1.928 1.944-1.928 3.556v7.022h-1zm-8.017 0v-7.391c0-2.908.972-4.995 2.917-6.284v3.097c-1.24.68-1.928 1.944-1.928 3.556v7.022h-1z"></path>
    </svg>
);
...
export const MedalIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 1 1 11.458-9.805 9.75 9.75 0 0 1-2.458 9.805Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9.75h7.5M12 3v2.25M12 21v-2.25M4.5 12H2.25m19.5 0h-2.25M17.657 6.343l-1.591 1.591M6.343 17.657l-1.591 1.591M17.657 17.657l-1.591-1.591M6.343 6.343l-1.591-1.591" />
...
export const ChartBarIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 0 1 3 21v-7.875M12.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v12c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125v-12Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 15.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v4.875c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125v-4.875Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v17.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V3.375Z" />
    </svg>
);
...
export const BuildingLibraryIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V5.63c0-.621-.504-1.125-1.125-1.125q-.104 0-.208.018L12 3.5l-6.875 1.145a1.125 1.125 0 0 0-.875 1.125V21h13.5Z" />
    </svg>
);
